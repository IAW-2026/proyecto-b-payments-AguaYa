...
const links = [
  ...
  { name: "Payments", href: "/seller/payments", icon: CreditCardIcon },
  { name: "Invoices", href: "/seller/invoices", icon: DocumentTextIcon },
  { name: "Revenue", href: "/seller/revenue", icon: BanknotesIcon },
  { name: "Customers", href: "/seller/customers", icon: UsersIcon },
  { name: "Settings", href: "/seller/settings", icon: Cog6ToothIcon },
];

export default function NavLinksSeller() {
